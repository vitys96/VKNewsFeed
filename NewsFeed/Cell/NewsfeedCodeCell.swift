...
final class NewsfeedCodeCell: UITableViewCell {
    ...
    let cardView: UIView = {
        let card = UIView()
        card.backgroundColor = #colorLiteral(red: 0.9999960065, green: 1, blue: 1, alpha: 1)
    ...
    func overlayThirdLayerOnTopView() {
        ...
        iconImageView.anchor(top: topView.topAnchor,
                             ...
                             size: CGSize(width: Constants.topViewHeight,
        ...
        nameLabel.anchor(top: topView.topAnchor,
                         ...
                         padding: UIEdgeInsets(top: 2, left: 8, bottom: 0, right: 8),
                         size: CGSize(width: 0, height: Constants.topViewHeight / 2 - 2))
        ...
        dateLabel.anchor(top: nil,
                         ...
                         trailing: topView.trailingAnchor,
                         padding: UIEdgeInsets(top: 8, left: 8, bottom: 2, right: 8),
